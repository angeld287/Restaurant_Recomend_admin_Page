<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insert.aspx.cs" Inherits="WebAppAdmin.Category_Manage.Insert" %>
	    ...
	    <div class="row">
            <div class="" id="myModal">
              <div class="modal-header">
                <h3>Registro de Categorias de Restaurantes</h3>
              </div>
              <div class="modal-body">
                <form id="form1" runat="server">
                    <div style="width: 500px">
                  <p><asp:TextBox ID="name" Text="" runat="server" CssClass="form-control" placeholder="Categoria"/></p>
                  <p><asp:Button ID="InsertBtn" CssClass="btn btn-primary" Text="Ingresar" runat="server" OnClick="Insert_Category" />
