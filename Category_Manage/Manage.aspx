...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="Insert.aspx">Insertar Nueva Categoria</a>
                    </li>
                    <li>
    ...
    <div>
    <asp:GridView ID="gUsers" runat="server" Width="300px" AutoGenerateColumns="False" CssClass="table table-bordered bs-table" DataSourceID="MySqlDataSource1" DataKeyNames="category_id" 
           OnRowDataBound="OnRowDataBound" EmptyDataText="No records has been added.">
              <Columns>
                    <asp:BoundField DataField="category_name" HeaderText="Name" ItemStyle-Width ="15%" ItemStyle-Wrap="false" ControlStyle-Width="300px"/>  
        ...
        <asp:SqlDataSource ID="MySqlDataSource1" ProviderName="MySql.Data.MySqlClient" runat="server" ConnectionString="<%$ ConnectionStrings:WebAppConnString %>"
            SelectCommand="SELECT category_id, category_name FROM category_restaurant"
            UpdateCommand="UPDATE category_restaurant SET category_name = @category_name WHERE category_id = @category_id"
            DeleteCommand="DELETE FROM category_restaurant WHERE category_id = @category_id">
            <UpdateParameters>
